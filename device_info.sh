...
TMPSCRIPT=$(mktemp /tmp/device_info_XXXXXX.applescript)
{
  ...
  echo "      set row count to 12"
  echo "      set value of cell 1 of column 1 to \"Field\""
  echo "      set value of cell 1 of column 2 to \"Value\""
  echo "      set value of cell 2 of column 1 to \"Hostname\""
  echo "      set value of cell 2 of column 2 to \"$HOSTNAME\""
  echo "      set value of cell 3 of column 1 to \"User\""
  echo "      set value of cell 3 of column 2 to \"$USER_NAME\""
  echo "      set value of cell 4 of column 1 to \"IP Address\""
  echo "      set value of cell 4 of column 2 to \"$IP\""
  echo "      set value of cell 5 of column 1 to \"MAC Address\""
  echo "      set value of cell 5 of column 2 to \"$MAC\""
  echo "      set value of cell 6 of column 1 to \"OS Version\""
  echo "      set value of cell 6 of column 2 to \"$OSFULL\""
  echo "      set value of cell 7 of column 1 to \"Architecture\""
  echo "      set value of cell 7 of column 2 to \"$ARCH_LABEL\""
  echo "      set value of cell 8 of column 1 to \"CPU\""
  echo "      set value of cell 8 of column 2 to \"$CPUFULL\""
  echo "      set value of cell 9 of column 1 to \"GPU\""
  echo "      set value of cell 9 of column 2 to \"$GPU\""
  echo "      set value of cell 10 of column 1 to \"Memory\""
  echo "      set value of cell 10 of column 2 to \"${MEM_GB} GB\""
  echo "      set value of cell 11 of column 1 to \"Storage (/)\""
  echo "      set value of cell 11 of column 2 to \"$DISK_INFO\""
  echo "      set value of cell 12 of column 1 to \"Uptime\""
  echo "      set value of cell 12 of column 2 to \"$UPTIME\""
  echo "    end tell"
  echo "  end tell"
